  ...
  return (
    <>
      ...
      <div className="flex flex-col gap-2 mb-4">
        <h3 className="text-2xl font-bold tracking-tighter">Nostr</h3>
        <ul>
          <li>
            <a className="link flex items-center" href="https://github.com/nostr-protocol/nips/blob/master/64.md">
              NIP-64 (GitHub)
            </a>
          </li>
        </ul>
